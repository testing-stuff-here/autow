...
jQuery(document).ready(function($) {
  ...
  $('#om-grid-guide-buttons input[type=radio]').change(function() {
    ...
    if (button != '') {
      ...
      $('.om-grid-guide').remove();    
      document.location.href = '?column=disabled&overlay=false&info=' + info;
    }      
  }); 
  ...
  $('#om-grid-guide-overlay').click(function() {
      ...
      document.location.href = '?column=' + column + '&overlay=true&info=' + info;
    }
    else {
      $('.om-grid-guide').css('z-index', -1);
      document.location.href = '?column=' + column + '&overlay=false&info=' + info;
    }      
  }); 
  ...
  $('#om-grid-guide-info').click(function() {
      ...
      document.location.href = '?column=' + column + '&overlay=' + overlay + '&info=true';
    }
    else {
      $('.region').removeClass('region-info-active');
      $('.wrapper').removeClass('wrapper-info-active'); 
      document.location.href = '?column=' + column + '&overlay=' + overlay + '&info=false';
    }      
  }); 
