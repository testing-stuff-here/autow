...
<div class="col-xs-12 wir-banner">
     <img src="/sites/default/themes/awbs/images/WIR/wir_banner.png" class="img-responsive center-block animated fadeIn">
</div>

<div class="hidden-xs hidden-sm wir-sub-text">
  <p>Each week, our editors bring you the best and most interesting highlights of automation taking place outside the factory setting.</p>
</div>
...
<div class="main-container container">
  ...
  <div class="row">
   ...
   <section class="col-sm-12 col-md-8" style="padding-left:20px; margin-bottom:10px; overflow-x: hidden; overflow-y: hidden;">
    <?php if (isset($node_content['field_360_fc_large']) && empty($node_content['field_viddler_id'])) : ?>
      <div class="awbs-content-image">
        <img src="<?php print '/sites/default/files/WIR/' . $node_content['field_360_fc_large']['#items'][0]['filename']; ?>" class="img-responsive center-block" />
      </div>
    <?php endif; ?>
    <div class="block-image-wir">
      <?php print render($page['content']);?>
    <div>
      <div class="wir-link" style="padding-bottom:10px;">
        <?php print($node_content['field_ld_link']['0']['#markup']); ?>
      </div>
    </section>

    <?php if (!empty($page['sidebar_second'])):?>
      <aside class="col-md-4 awbs-sidebar-overall" role="complementary">
       <?php print render($page['sidebar_second'][0]); ?>
      </aside>  <!-- /#sidebar-second -->
      <aside class="hidden-xs hidden-sm col-md-4 awbs-sidebar-overall" role="complementary">
        <?php if($related_links == TRUE): ?>
          <div id="related-links" class="related-links">
            <div class="related-links__title"><b>Related links</b></div>
            <div class="related-links__description"><b>Sponsored</b></div>
            <?php print views_embed_view('related_links', 'block', $node->nid); ?>
          </div>
        <?php endif; ?>
