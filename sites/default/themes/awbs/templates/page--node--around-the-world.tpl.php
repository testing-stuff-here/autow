...
<div class="col-xs-12 wir-banner">
     <img src="/sites/default/files/aatw_header.png" class="img-responsive center-block animated fadeIn">
</div>
...
<div class="main-container container">
  ...
  <?php if (($page) && (arg(0) != 'home')): ?>
    <div class="row awbs-content-top">
      <section>
        <div class="col-xs-12">
          <div class="row">
          <?php $reportingFrom = $node->field_reporting_from['und'][0]['safe_value']; ?>
          <div class="col-xs-12 country">Reporting from <?php print $reportingFrom . ' <img src="/sites/default/themes/awbs/images/ATW/' . $reportingFrom .  'flag.png">'; ?></div>
  ...
  <div class="row">
    ...
    <div class="awbs-content-image">
      <img src="<?php print '/sites/default/files/' . $node_content['field_image']['#items'][0]['filename']; ?>" class="img-responsive center-block" />
    </div>
    <div class="block-image-atw">
    ...
    <div>
        ...
        <?php if (!empty($page['sidebar_second'])):?>
          <aside class="col-md-4 awbs-sidebar-overall" role="complementary">
           <?php print render($page['sidebar_second']); ?>
          </aside>  <!-- /#sidebar-second -->
        <?php endif; ?>
    <div class="visible-xs visible-sm col-xs-12">
      <a href="http://oascentral.automationworld.com/RealMedia/ads/click_lx.ads/automationworld/L15/558667888/Right1/Summit/AW_Moxa_2016_Around_The_World/300x250_AW-BLOG-Banner_MOXA_IIOT.jpg/79416562584661594a75344143546f48?x" onclick="ga('send', 'event', 'Moxa Mobile Ad Links', 'Click', '0');">
        <img alt="Moxa" src="/sites/default/files/moxaad.png" class="img-responsive center-block animated fadeIn" ></a>
      </div>

    <section class="col-sm-12" style="padding-left:20px; overflow-x: hidden; overflow-y: hidden;">
