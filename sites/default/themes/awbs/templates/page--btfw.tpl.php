...
<div
  class="container awbs-advertising-header <?php if (isset($enable_expo_countdown)) {
    print 'expo-countdown';
  } ?>">
...
<div class="main-container container">
  ...
  <div class="row">
    <section class="col-sm-12 col-md-12"
             style="padding-left:20px; overflow-x: hidden; overflow-y: hidden;">
