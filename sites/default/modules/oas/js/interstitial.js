...
displayfiles: ['/sites/default/modules/oas/interstitial-iframe.html'],
...
defineheader: '<div class="headerbar"><span id="countdown-wrapper">This ad will automatically close in: <span id="timer">15</span> seconds</span><a href="#" onClick="javascript:interstitialBox.closeit(); return false"><img src="/sites/default/modules/oas/css/images/closeit.gif" style="border: 0" title="Close Box"/></a></div>',
...
if (getCookie(stitialvars.cookiename)==null || parseInt(getCookie(stitialvars.cookiename))!=parseInt(stitialvars.cookieduration) || window.location.pathname == interstitialBox.demoUrl){ //if persistent cookie is empty or admin has changed number of days to persist from that of the stored value (meaning, reset it)
